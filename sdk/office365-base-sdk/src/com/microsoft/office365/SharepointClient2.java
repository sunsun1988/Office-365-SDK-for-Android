...
public class SharepointClient2 extends OfficeClient2 {
	...
	public SharepointClient2(String serverUrl, String siteRelativeUrl,
	...
	protected ListenableFuture<String> getFormDigest() {
		...
		HttpConnectionFuture2 future = connection.execute(request);
